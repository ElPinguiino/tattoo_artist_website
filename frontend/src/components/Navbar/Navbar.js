...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div
              className={`top-0 right-0 w-[80vw] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-10 pl-20 text-white fixed h-full z-40  ease-in-out duration-300 ${
