...
<StyledForm>
  ...
  <StyledOuterDiv>
    <StyledLabel>Tattoo Color Choices:</StyledLabel>
    <StyledInput />
  </StyledOuterDiv>
  <StyledOuterDiv>
  ...
  <StyledOuterDiv>
    <StyledLabel>Image Refrence:</StyledLabel>
    <StyledInput type="file"/>
  </StyledOuterDiv>
  <StyledOuterDiv>
    <StyledLabel>Workaround Existing Tattoos:</StyledLabel>
    <StyledInput type="text"/>
  </StyledOuterDiv>
  <StyledOuterDiv>
    <StyledLabel>Existing Tattoos Images:</StyledLabel>
    <StyledInput type="file"/>
  </StyledOuterDiv>
  <StyledOuterDiv>
    <StyledLabel>Preferred Days of Week:</StyledLabel>
    <StyledInput type="checbox"/>
  </StyledOuterDiv>
  <StyledOuterDiv>
    <StyledLabel>Preferred Time of Day:</StyledLabel>
    <StyledInput type="checbox"/>
  </StyledOuterDiv>
  <StyledOuterDiv>
